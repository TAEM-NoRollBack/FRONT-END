...
// 결과 리스트 컨테이너(ex: #results)에 위임 클릭
document.addEventListener('click', (e) => {
  ...
  const item = {
    ...
    reviewCount: Number(card.dataset.reviews),
  ...
  // ✅ 형제 폴더로 이동: mainpage → market
  const url = new URL('../market/market.html', location.href);
